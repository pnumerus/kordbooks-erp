...
FILE_LIST=(
  ...
  # "client_portal/src/components/table.vue"
  ...
  "kordbooks_erp/hooks.py"
  "kordbooks_erp/kordbooks_practice/page/staff_dashboard/staff_dashboard.js"
  "kordbooks_erp/kordbooks_practice/page/staff_dashboard/staff_dashboard.json"
  "kordbooks_erp/kordbooks_practice/page/staff_dashboard/staff_dashboard.py"
)
